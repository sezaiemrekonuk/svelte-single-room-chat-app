...
{#if $authState == null}
	<main class="center">
		<button on:click={handleClick} disabled={loggingIn}> Log In With Google </button>
	</main>
{:else if $currentFirestoreUser == null}
	<main class="center">
		<span>Logging User Data...</span>
	</main>
{:else}
	<main class="app-container">
		<nav>
			<span class="header-title">Realtime Chatapp With Svelte + Firebase</span>
			<div class="action">
		...
		<form on:submit|preventDefault={handleSubmit} class="message-form">
			<input type="text" name="MessageInput" id="messageInput" bind:value={currentInput} />
